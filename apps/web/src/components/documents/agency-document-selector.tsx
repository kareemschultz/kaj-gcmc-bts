        ...
        templates: [
          {
            ...
            requiredFields: ['TIN', 'Full Name', 'Address', 'Income Details', 'Tax Computation'],
            exampleFields: {
              'TIN': '123456789',
              'Full Name': 'John Doe',
        ...
        templates: [
          {
            ...
            requiredFields: ['VAT Number', 'Business Name', 'Period', 'Sales', 'Purchases', 'VAT Due'],
            exampleFields: {
        ...
        templates: [
          {
            ...
            requiredFields: ['Company TIN', 'Company Name', 'Financial Statements', 'Tax Computation'],
            exampleFields: {
        ...
        templates: [
          {
            ...
            requiredFields: ['Employer Number', 'Period', 'Employee List', 'Wages', 'Contributions'],
            exampleFields: {
        ...
        templates: [
          {
            ...
            requiredFields: ['Employee Name', 'Date of Birth', 'Address', 'Position', 'Salary'],
            exampleFields: {
        ...
        templates: [
          {
            ...
            requiredFields: ['Company Name', 'Directors', 'Share Capital', 'Registered Address', 'Business Activities'],
            exampleFields: {
        ...
        templates: [
          {
            ...
            requiredFields: ['Applicant Name', 'Passport Details', 'Employer Details', 'Position', 'Contract Period'],
            exampleFields: {
...
export function AgencyDocumentSelector({
  ...
  useEffect(() => {
    ...
    if (selectedDocumentTypeData?.templates && selectedDocumentTypeData.templates.length > 0) {
      suggestions.push({
        type: 'template',
  ...
  }, [selectedAgency, selectedDocumentType, selectedAgencyData, selectedDocumentTypeData]);
  ...
  return (
    <div className={cn("space-y-6", className)}>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-center">
              <p className="text-2xl font-bold text-green-600">
                {ENHANCED_AGENCY_CATEGORIES.reduce((sum, agency) => sum + agency.documentTypes.length, 0)}
              </p>
      ...
      {/* Agency Selection */}
      <Tabs value={selectedAgency} onValueChange={onAgencyChange} className="w-full">
        <TabsList className="grid w-full grid-cols-4 h-auto p-1">
          {ENHANCED_AGENCY_CATEGORIES.map((agency) => (
            ...
            >
              ...
              <span className="text-xs font-medium">{agency.shortName}</span>
        ...
        {ENHANCED_AGENCY_CATEGORIES.map((agency) => (
          <TabsContent key={agency.id} value={agency.id} className="space-y-6">
              ...
              <CardHeader>
                ...
                {showStatistics && (
                  <div className="grid grid-cols-3 gap-4 mt-4 p-4 bg-gray-50 rounded-lg">
                    <div className="text-center">
                      <p className="text-lg font-semibold text-blue-600">{agency.recentDocuments}</p>
                      <p className="text-xs text-muted-foreground">Recent Documents</p>
                    </div>
                    <div className="text-center">
                      <p className="text-lg font-semibold text-green-600">{agency.complianceScore}%</p>
                      <p className="text-xs text-muted-foreground">Compliance Score</p>
                    </div>
                    <div className="text-center">
                      <p className="text-lg font-semibold text-orange-600">{agency.pendingDeadlines}</p>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge
                              variant={
                                documentType.urgencyLevel === 'critical' ? 'destructive' :
                                documentType.urgencyLevel === 'high' ? 'default' :
                                documentType.urgencyLevel === 'medium' ? 'secondary' : 'outline'
                              }
                              className="text-xs"
                            >
                        ...
                        <div className="flex items-center gap-2">
                          {documentType.templates && documentType.templates.length > 0 && (
                            <Badge variant="outline" className="text-xs">
                              {documentType.templates.length} template{documentType.templates.length !== 1 ? 's' : ''}
                            </Badge>
                          )}
            ...
            {/* Templates Section */}
            {showTemplates && selectedDocumentTypeData && selectedDocumentTypeData.templates && (
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Pre-filled forms and templates for {selectedDocumentTypeData.name}
                  </p>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {selectedDocumentTypeData.templates.map((template, index) => (
                      <motion.div
                        key={template.id}
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="space-y-2">
                              <div>
                                <Label className="text-xs text-gray-600">Required Fields:</Label>
                                <div className="flex flex-wrap gap-1 mt-1">
                                  ...
                                  {template.requiredFields.length > 4 && (
                                    <Badge variant="outline" className="text-xs">
                                      +{template.requiredFields.length - 4} more
                                    </Badge>
                                  )}
                                </div>
                              </div>
                              ...
                              <Collapsible>
                                ...
                                <CollapsibleContent>
                                  <div className="mt-2 p-2 bg-gray-50 rounded text-xs space-y-1">
                                    {Object.entries(template.exampleFields).map(([key, value]) => (
