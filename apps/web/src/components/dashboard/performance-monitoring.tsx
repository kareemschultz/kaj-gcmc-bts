					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							<motion.div
								...
								className={cn("rounded-lg p-2", config.text)}
								style={{
									backgroundColor: `${config.text.replace("text-", "")}20`,
								}}
							>
							...
							<div>
								...
								<motion.div
									...
									className={cn("font-bold text-2xl", config.text)}
								>
									{value}
									{unit}
								</motion.div>
...
export function PerformanceMonitoring() {
	...
	const systemMetrics = [
		...
		},
		{
			...
			unit: "%",
			icon: HardDrive,
			status: getStatus(metrics.memory, {
				excellent: 70,
				good: 80,
				warning: 90,
			}),
		...
		},
		{
			...
			unit: "ms",
			icon: Clock,
			status: getStatus(metrics.responseTime, {
				excellent: 100,
				good: 150,
				warning: 200,
			}),
		...
		},
		{
			...
			unit: "%",
			icon: AlertTriangle,
			status: getStatus(Number.parseFloat(metrics.errorRate), {
				excellent: 0.5,
				good: 1.0,
				warning: 2.0,
			}),
				...
				<Card className="border-green-200 bg-gradient-to-r from-green-50 to-blue-50 dark:border-green-800 dark:from-green-900/20 dark:to-blue-900/20">
					...
					<CardContent>
						<div className="grid gap-4 md:grid-cols-3">
							...
							>
								<div className="font-bold text-3xl text-green-600">99.9%</div>
							...
							<motion.div
								...
								className="text-center"
							>
								<div className="font-bold text-3xl text-blue-600">0</div>
							...
							<motion.div
								...
								className="text-center"
							>
								<div className="font-bold text-3xl text-orange-600">2</div>
								<div className="text-muted-foreground text-sm">
									Minor Alerts
								</div>
							</motion.div>
