		...
		>
			<div className="relative">
				...
				<svg
					width={size}
					height={size}
					className="-rotate-90 relative transform"
				>
					{/* Background circle */}
					<circle
						cx={size / 2}
					...
					<div className="mb-4 flex items-start justify-between">
						...
						<div className="text-right">
							<motion.div
								...
								className={cn("font-bold text-2xl", getScoreColor(score))}
							>
								{score}%
							</motion.div>
							{trend !== undefined && (
...
export function ComplianceVisualization() {
	...
	return (
		...
		>
			...
			>
				<h2 className="mb-2 font-bold text-3xl">Compliance Dashboard</h2>
			...
			>
				<Card className="border-0 bg-gradient-to-br from-white to-gray-50/50 shadow-xl ring-1 ring-gray-200/50 dark:from-gray-900 dark:to-gray-800/50 dark:ring-gray-700/50">
			...
			>
				<Card className="border-blue-200 bg-gradient-to-r from-blue-50 to-cyan-50 dark:border-blue-800 dark:from-blue-900/20 dark:to-cyan-900/20">
					<CardHeader>
						...
						<div className="grid gap-4 md:grid-cols-3">
							...
							>
								...
								<div>
									...
									<p className="text-muted-foreground text-xs">Q4 Goal</p>
								</div>
							</motion.div>
						</div>
					</CardContent>
