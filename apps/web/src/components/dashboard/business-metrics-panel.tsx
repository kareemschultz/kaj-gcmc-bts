    ...
    >
      ...
      {label && (
        <motion.p
          ...
          className="mt-2 text-sm font-medium text-center text-muted-foreground"
        >
          {label}
        </motion.p>
      )}
...
function AnimatedGauge({
  ...
  return (
    <Card className="bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50 border-0 shadow-lg ring-1 ring-gray-200/50 dark:ring-gray-700/50">
...
function AnimatedMetricCard({
  ...
  return (
    ...
    >
      <Card className="bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50 border-0 shadow-lg ring-1 ring-gray-200/50 dark:ring-gray-700/50 hover:shadow-xl transition-all duration-300">
        <CardContent className="p-6">
