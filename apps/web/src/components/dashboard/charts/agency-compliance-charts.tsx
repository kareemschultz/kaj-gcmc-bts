	...
	return (
		<div className="space-y-6">
			...
			<div className="mb-6 flex items-center gap-3">
				...
				<div>
					<h2 className="font-semibold text-xl">GRA Compliance Dashboard</h2>
					<p className="text-muted-foreground text-sm">
						Guyana Revenue Authority tax compliance tracking
					</p>
				</div>
				<Badge
					variant={graData.complianceScore > 85 ? "default" : "secondary"}
					className="ml-auto"
				>
	...
	return (
		<div className="space-y-6">
			...
			<div className="mb-6 flex items-center gap-3">
				...
				<div>
					<h2 className="font-semibold text-xl">NIS Performance Dashboard</h2>
					<p className="text-muted-foreground text-sm">
						National Insurance Scheme compliance and contributions
					</p>
				</div>
				<Badge
					variant={nisData.overallScore > 90 ? "default" : "secondary"}
					className="ml-auto"
				>
	...
	return (
		<div className="space-y-6">
			...
			<div className="mb-6 flex items-center gap-3">
				...
				<div>
					<h2 className="font-semibold text-xl">DCRA Status Dashboard</h2>
					<p className="text-muted-foreground text-sm">
						Deeds and Commercial Registry Authority tracking
					</p>
				</div>
				<Badge
					variant={dcraData.complianceHealth > 85 ? "default" : "secondary"}
					className="ml-auto"
				>
...
export function ImmigrationAnalyticsCharts({
	data,
}: {
	...
	return (
		<div className="space-y-6">
			...
			<div className="mb-6 flex items-center gap-3">
				...
				<div>
					<h2 className="font-semibold text-xl">Immigration Analytics</h2>
					<p className="text-muted-foreground text-sm">
						Immigration permit and application tracking
					</p>
				</div>
				<Badge
					variant={
						immigrationData.complianceRate > 85 ? "default" : "secondary"
					}
					className="ml-auto"
				>
	...
	const agencies = [
		{
			...
			name: "GRA",
			icon: Shield,
			description: "Guyana Revenue Authority",
		},
		{
			id: "nis",
			name: "NIS",
			icon: Users,
			description: "National Insurance Scheme",
		},
		{
			id: "dcra",
			name: "DCRA",
			icon: Building,
			description: "Deeds & Commercial Registry",
		},
		{
			id: "immigration",
			name: "Immigration",
		...
		>
			<div className="border-gray-200 border-b pb-4">
				...
				<p className="mt-2 text-gray-600">
					Comprehensive compliance tracking across all Guyanese regulatory
					agencies
				</p>
			</div>
