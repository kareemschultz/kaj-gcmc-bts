...
const generateServiceMetrics = (): ServiceMetricsData => ({
	...
	slaPerformance: [
		...
		{
			service: "Immigration Processing",
			slaTarget: 120,
			actualTime: 98,
			compliance: 92.1,
		},
...
function GaugeChart({
	...
	return (
		<div className="flex flex-col items-center space-y-2">
			...
			<div className="text-center font-medium text-sm">{title}</div>
		</div>
	);
}
			...
			<Card className="relative overflow-hidden">
				<CardContent className="p-4">
					<div className="mb-3 flex items-center justify-between">
						<div
							className={cn("rounded-full p-2", getStatusColor(metric.status))}
						>
							...
							<CardContent className="p-4">
								<div className="mb-3 flex items-center justify-between">
									...
									<div className="flex items-center gap-1 text-xs">
										...
										>
											{process.improvement > 0 ? "+" : ""}
											{process.improvement.toFixed(1)}%
										</span>
									</div>
								</div>

								<h4 className="mb-2 font-medium">{process.name}</h4>
								<div className="space-y-2">
						...
						<CardContent className="p-4">
							<div className="space-y-3">
								...
								<div className="text-center">
									...
									<div className="text-muted-foreground text-sm">Utilized</div>
								</div>
