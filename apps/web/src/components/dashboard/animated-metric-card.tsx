...
export function AdvancedStatsSection() {
  ...
  const metricsData = [
    ...
    },
    {
      ...
      icon: () => (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m0 0V9a3 3 0 003-3m-3 6.75V9a3 3 0 003-3m-3 6.75a3 3 0 01-3-3V6a3 3 0 013-3m0 0a3 3 0 013 3v6.75" />
        </svg>
      ),
      color: "blue" as const,
      showProgress: true,
