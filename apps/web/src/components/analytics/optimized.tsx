...
import { ChartContainer, customTooltipProps } from '@/components/ui/chart-container';
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="absolute right-0 z-50 mt-2 w-64 bg-white border rounded-lg shadow-lg p-4"
          >
...
export function ExportButton({ data, chartRef, filename = 'analytics-export', className }: ExportButtonProps) {
