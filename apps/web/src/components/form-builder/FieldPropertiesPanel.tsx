...
export function FieldPropertiesPanel({ field, onUpdate, readonly }: FieldPropertiesPanelProps) {
  ...
  const handleOptionsUpdate = useCallback((options: FormFieldOption[]) => {
    handleUpdate({ options } as any);
  }, [handleUpdate]);

  // Handle validation rules update
  const handleValidationRulesUpdate = useCallback((validationRules: ValidationRule[]) => {
    handleUpdate({ validationRules });
  }, [handleUpdate]);

  // Handle conditional logic update
  const handleConditionalLogicUpdate = useCallback((conditions: ConditionalLogic[]) => {
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ minLength: parseInt(e.target.value) || undefined } as any)}
                  disabled={readonly}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ maxLength: parseInt(e.target.value) || undefined } as any)}
                  disabled={readonly}
                />
              </div>
            </div>
            ...
            {field.type === "text" && (
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ pattern: e.target.value } as any)}
                  placeholder="^[A-Z0-9]+$"
                  disabled={readonly}
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ min: parseFloat(e.target.value) || undefined } as any)}
                  disabled={readonly}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ max: parseFloat(e.target.value) || undefined } as any)}
                  disabled={readonly}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ step: parseFloat(e.target.value) || undefined } as any)}
                  placeholder="1"
                  disabled={readonly}
                />
              </div>
              {field.type !== "percentage" && (
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleUpdate({ precision: parseInt(e.target.value) || undefined } as any)}
                    placeholder="2"
                    disabled={readonly}
                  />
                </div>
            ...
            {field.type === "currency" && (
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => handleUpdate({ currency: value } as any)}
                  disabled={readonly}
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ minDate: e.target.value } as any)}
                  disabled={readonly}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ maxDate: e.target.value } as any)}
                  disabled={readonly}
                />
              </div>
            </div>
            ...
            {field.type !== "time" && (
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => handleUpdate({ businessDaysOnly: checked } as any)}
                  disabled={readonly}
                />
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleUpdate({ maxFiles: parseInt(e.target.value) || 1 } as any)}
                  min="1"
                  disabled={readonly}
                />
              </div>
              <div>
                ...
                <Input
                  id="maxSize"
                  type="number"
                  value={((localField as any).maxSize || 10485760) / 1024 / 1024}
                  onChange={(e) => handleUpdate({ maxSize: (parseFloat(e.target.value) || 10) * 1024 * 1024 } as any)}
                  disabled={readonly}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleUpdate({ allowedTypes: e.target.value.split(",").map(s => s.trim()) } as any)}
      ...
      case "calculated":
        return (
          <CalculationEditor
            ...
            onUpdate={(calculation, dependsOn) => handleUpdate({ calculation, dependsOn } as any)}
            readonly={readonly}
          />
        );
...
function OptionsEditor({ options, onUpdate, readonly }: OptionsEditorProps) {
  ...
  const handleUpdateOption = (index: number, updates: Partial<FormFieldOption>) => {
      ...
      <div className="space-y-3">
        ...
        {localOptions.length === 0 && (
          <div className="text-center py-6 text-gray-500">
            ...
            <p className="text-sm">No options yet. Add options for users to choose from.</p>
          </div>
        )}
      </div>
    </div>
...
function ValidationRulesEditor({ rules, onUpdate, readonly }: ValidationRulesEditorProps) {
  return (
    <Card>
      <CardHeader>
...
function ConditionalLogicEditor({ conditions, onUpdate, readonly }: ConditionalLogicEditorProps) {
  return (
    <Card>
      <CardHeader>
...
function CalculationEditor({ calculation, dependsOn, onUpdate, readonly }: CalculationEditorProps) {
  return (
    <Card>
      <CardHeader>
