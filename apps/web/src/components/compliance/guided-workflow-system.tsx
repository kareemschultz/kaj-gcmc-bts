...
const mockWorkflow: WorkflowStep[] = [
	{
		...
		description:
			"Register your business with the Deeds and Commercial Registry Authority",
		agency: "DCRA",
		...
		helpContent: {
			overview:
				"Business registration is the first step in establishing a legal business entity in Guyana.",
			steps: [
		...
		validation: [
			{
				...
				message:
					"Business name is required and must be between 3-100 characters",
			},
		],
	},
	{
		...
		description:
			"Register for tax obligations with the Guyana Revenue Authority",
		agency: "GRA",
		...
		helpContent: {
			overview:
				"Tax registration establishes your business for VAT, income tax, and other obligations.",
			steps: [
	...
	},
	{
		...
		helpContent: {
			overview:
				"Register as an employer to make NIS contributions for your employees.",
			steps: [
...
export function GuidedWorkflowSystem({ className }: GuidedWorkflowSystemProps) {
	...
	const completedSteps = mockWorkflow.filter(
				...
				<div className="flex items-center gap-4">
					...
					>
						...
						{unreadNotifications > 0 && (
							<span className="-top-1 -right-1 absolute flex h-5 w-5 items-center justify-center rounded-full bg-destructive text-white text-xs">
								{unreadNotifications}
							</span>
						)}
					</Button>
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Complete list of documents for this workflow
				</CardDescription>
			</CardHeader>
			<CardContent>
			...
			<Card>
				...
				<CardContent className="space-y-4">
					<div>
						...
						<p className="text-muted-foreground text-sm">
							{step.helpContent.overview}
						</p>
					</div>

					<div>
						<h4 className="mb-2 font-medium">Steps to Complete</h4>
