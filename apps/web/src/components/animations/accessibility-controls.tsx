...
export function AccessibilityControls({
  ...
  const handleToggleDataVisualization = () => {
    updateConfig({
      enableDataVisualizationAnimations: !config.enableDataVisualizationAnimations,
    });
  };
      ...
      >
        ...
        {showPerformanceMetrics && (
          <Badge
            ...
            className={cn(
              'text-xs',
              getPerformanceStatus().color === 'green' && 'border-green-500 text-green-700',
              getPerformanceStatus().color === 'yellow' && 'border-yellow-500 text-yellow-700',
              getPerformanceStatus().color === 'red' && 'border-red-500 text-red-700'
            )}
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            {/* Controls Panel */}
            <motion.div
              className="absolute top-full right-0 mt-2 w-80 bg-white rounded-lg border shadow-lg p-4 z-50"
            ...
            >
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {(['slow', 'normal', 'fast'] as const).map((speed) => (
                      <Button
                        key={speed}
                        variant={config.defaultSpeed === speed ? 'default' : 'outline'}
                        size="sm"
                ...
                <div className="border-t pt-3 space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <Label htmlFor="form-validation-animations" className="text-sm">
                      Form Validation
                    </Label>
                    <Switch
