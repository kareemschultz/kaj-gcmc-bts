...
const complianceNeedsSchema = z.object({
	...
	estimatedAnnualRevenue: z
		.enum(["under_100k", "100k_500k", "500k_1m", "1m_5m", "5m_plus"])
		.optional(),
});
										...
										<FormControl>
											...
											>
												...
												<SelectContent>
													...
													<SelectItem value="mahaica-berbice">
														Mahaica-Berbice
													</SelectItem>
													<SelectItem value="east-berbice-corentyne">
														East Berbice-Corentyne
													</SelectItem>
													<SelectItem value="cuyuni-mazaruni">
														Cuyuni-Mazaruni
													</SelectItem>
													<SelectItem value="potaro-siparuni">
														Potaro-Siparuni
													</SelectItem>
													<SelectItem value="upper-takutu-upper-essequibo">
														Upper Takutu-Upper Essequibo
													</SelectItem>
													<SelectItem value="barima-waini">
														Barima-Waini
													</SelectItem>
												</SelectContent>
											</Select>
							...
							render={({ field }) => (
								<FormItem className="flex flex-row items-start space-x-3 space-y-0">
									...
									<div className="space-y-1 leading-none">
										...
										<FormDescription>
											Check this if your mailing address is the same as your
											business address
										</FormDescription>
									</div>
								</FormItem>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						<p className="mb-4 text-gray-600 text-sm">
							Select the compliance services you need. We'll help you stay
							compliant with all relevant Guyanese regulations.
						</p>
									...
									render={({ field }) => (
										<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-lg border p-4">
											...
											<div className="space-y-1 leading-none">
												...
												<FormDescription>
													Income tax, VAT, and other tax obligations with the
									...
									render={({ field }) => (
										<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-lg border p-4">
											...
											<div className="space-y-1 leading-none">
												...
												<FormDescription>
													Business registration and corporate compliance with
													the Department of Cooperatives and Rural Affairs
												</FormDescription>
											</div>
										</FormItem>
									)}
									...
									render={({ field }) => (
										<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-lg border p-4">
											...
											<div className="space-y-1 leading-none">
												...
												<FormDescription>
													National Insurance Scheme contributions for employees
													and self-employed
												</FormDescription>
											</div>
										</FormItem>
									...
									render={({ field }) => (
										<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-lg border p-4">
											...
											<div className="space-y-1 leading-none">
												...
												<FormDescription>
													Environmental permits and compliance with the
										...
										<FormControl>
											...
											>
												...
												<SelectContent>
													...
													<SelectItem value="1m_5m">
														$1,000,000 - $5,000,000
													</SelectItem>
													<SelectItem value="5m_plus">
														Over $5,000,000
													</SelectItem>
												</SelectContent>
											</Select>
			...
			<Card>
				...
				<CardContent>
					<p className="mb-6 text-gray-600 text-sm">
						Upload the required documents to complete your onboarding. All
						...
						<div>
							...
							<div className="grid grid-cols-2 gap-4 text-sm">
								...
								<div>
									...
									{basicData.clientType?.replace("_", " ")}
								</div>
							</div>
						</div>
