...
export function WizardLayout({
  ...
  const [lastSaved, setLastSaved] = useState<Date | null>(state.savedAt || null);
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 ${mobileOptimized ? 'px-4' : 'px-8'} py-6`}>
      {/* Header */}
      <div className="mx-auto max-w-4xl">
        ...
        {/* Step indicators */}
        <div className={`mb-8 overflow-x-auto ${mobileOptimized ? 'pb-2' : ''}`}>
          <div className="flex items-center space-x-2 md:space-x-4 min-w-max md:min-w-0">
            {state.steps.map((step, index) => (
              <React.Fragment key={step.id}>
                ...
                >
                  ...
                  <span className={`font-medium ${mobileOptimized ? 'hidden sm:inline truncate' : ''}`}>
                    {step.title}
                  </span>
                  {step.isOptional && (
                ...
                {index < state.steps.length - 1 && (
                  <div className="hidden md:block h-px w-4 bg-gray-300" />
                )}
              </React.Fragment>
            ))}
          </div>
          ...
          <div className="mt-8 hidden lg:block">
            <div className="rounded-lg bg-gray-50 p-4">
              ...
              <div className="mt-2 grid grid-cols-2 gap-4 text-sm text-gray-600">
                <div>
                  <kbd className="rounded bg-gray-200 px-2 py-1">Ctrl/Cmd + ←</kbd>
                ...
                <div>
                  <kbd className="rounded bg-gray-200 px-2 py-1">Ctrl/Cmd + S</kbd>
