					...
					<div className="grid grid-cols-1 gap-4 md:grid-cols-3">
						...
						<div className="space-y-2">
							...
							<Select
								...
								onValueChange={(value) => handleChange("businessRegion", value)}
							>
								<SelectTrigger>
						...
						<div className="space-y-2">
							...
							<Input
								...
								onChange={(e) =>
									handleChange("businessPostalCode", e.target.value)
								}
							/>
						</div>
					</div>
	...
	return (
		<Card>
			...
			<CardContent className="space-y-6">
				<p className="text-gray-600 text-sm">
					Select the compliance services you need. We'll help you stay compliant
					with all relevant Guyanese regulations.
				</p>
						...
						<div className="flex items-start space-x-3">
							<Checkbox
								...
								onCheckedChange={(checked) =>
									handleCheckboxChange("gra", checked as boolean)
								}
							/>
							<div>
								<Label className="font-medium">GRA Tax Compliance</Label>
								<p className="mt-1 text-gray-600 text-sm">
									Income tax, VAT, and other tax obligations with the Guyana
									Revenue Authority
								</p>
							</div>
						</div>
					...
					<Card className="border border-gray-200 p-4">
						<div className="flex items-start space-x-3">
							<Checkbox
								...
								onCheckedChange={(checked) =>
									handleCheckboxChange("dcra", checked as boolean)
								}
							/>
							<div>
					...
					<Card className="border border-gray-200 p-4">
						<div className="flex items-start space-x-3">
							<Checkbox
								...
								onCheckedChange={(checked) =>
									handleCheckboxChange("nis", checked as boolean)
								}
							/>
							<div>
								<Label className="font-medium">NIS Contributions</Label>
								<p className="mt-1 text-gray-600 text-sm">
									National Insurance Scheme contributions for employees and
									self-employed
								</p>
							</div>
						</div>
					...
					<Card className="border border-gray-200 p-4">
						<div className="flex items-start space-x-3">
							<Checkbox
								...
								onCheckedChange={(checked) =>
									handleCheckboxChange("epa", checked as boolean)
								}
							/>
							<div>
				...
				<div className="space-y-2">
					...
					<Select
						...
						onValueChange={(value) =>
							handleSelectChange("estimatedAnnualRevenue", value)
						}
					>
						<SelectTrigger>
			...
			<Card>
				...
				<CardContent className="space-y-6">
					...
					{selectedCompliance.length > 0 && (
						<div>
							<h4 className="mb-2 font-medium">Selected Services</h4>
