...
const availableServices: Service[] = [
  {
    ...
    description: "Complete preparation and filing of individual income tax returns",
    category: "Tax Services",
    basePrice: 15000,
    estimatedDuration: "5-7 business days",
    requirements: ["Income statements", "Previous tax returns", "ID documents"],
    features: ["Tax optimization", "E-filing", "Audit support", "Next year planning"],
    recommended: true,
  },
  {
    ...
    requirements: ["Financial statements", "Business registration", "Bank statements"],
    features: ["Corporate tax filing", "Expense optimization", "Compliance review", "Tax planning"],
  },
  {
    id: "bookkeeping",
    ...
    requirements: ["Bank statements", "Receipts and invoices", "Previous records"],
    features: ["Monthly reports", "Expense tracking", "Reconciliation", "Digital records"],
  },
  {
    ...
    features: ["Name reservation", "Legal documentation", "Registration filing", "Post-registration support"],
  },
  {
    id: "compliance_audit",
    ...
    requirements: ["All business records", "Previous filings", "Current operations info"],
    features: ["Full compliance review", "Risk assessment", "Remediation plan", "Ongoing support"],
  },
  {
    id: "payroll_services",
    ...
    requirements: ["Employee information", "Salary details", "Previous payroll records"],
    features: ["Salary processing", "NIS calculations", "Tax deductions", "Payroll reports"],
  },
];
...
const requirementsSchema = z.object({
  ...
  communicationPreference: z.enum(["email", "phone", "whatsapp", "in_person"]).default("email"),
...
const pricingSchema = z.object({
  agreedToEstimate: z.boolean().refine(val => val, "Must agree to pricing estimate"),
  paymentMethod: z.enum(["bank_transfer", "cash", "check", "card"]),
  paymentSchedule: z.enum(["full_upfront", "50_50", "monthly"]).default("50_50"),
          ...
          {selectedServices.length > 0 && (
            <Card className="mt-6 bg-green-50 border-green-200">
              <CardContent className="pt-6">
                <h4 className="font-semibold text-green-900 mb-2">Selected Services Summary</h4>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Select value={data.priority || "standard"} onValueChange={(value) => handleChange("priority", value)}>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => handleChange("isExistingClient", checked)}
          />
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-600 mb-4">
            Please confirm which documents you have available for the selected services.
          </p>
            ...
            {requiredDocuments.map((document) => (
              <div key={document} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleDocumentCheck(document, checked as boolean)}
                />
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => handleChange("communicationPreference", value)}
            >
              <SelectTrigger className="mt-2">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleChange("scheduledMeetingRequired", checked)}
            />
          ...
          {data.scheduledMeetingRequired && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-6">
              ...
              <div>
                ...
                <Select value={data.meetingTime || ""} onValueChange={(value) => handleChange("meetingTime", value)}>
                  <SelectTrigger className="mt-2">
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            {serviceData.priority !== "standard" && (
              <div className="flex justify-between text-orange-600">
                <span>{serviceData.priority === "urgent" ? "Urgent" : "Emergency"} Fee</span>
                <span>+{serviceData.priority === "urgent" ? "25%" : "50%"}</span>
              </div>
            )}
          ...
          <div className="mt-6 flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleChange("agreedToEstimate", checked)}
            />
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Select value={data.paymentMethod || ""} onValueChange={(value) => handleChange("paymentMethod", value)}>
              <SelectTrigger className="mt-2">
          ...
          <div>
            ...
            <Select value={data.paymentSchedule || "50_50"} onValueChange={(value) => handleChange("paymentSchedule", value)}>
              <SelectTrigger className="mt-2">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
