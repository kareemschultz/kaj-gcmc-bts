	...
	return (
		<div className={cn("space-y-4", className)}>
			{Object.entries(groupedActivities).map(([dateGroup, groupActivities]) => (
				<div key={dateGroup} className="space-y-3">
					{groupByDate && dateGroup !== "All Activities" && (
						<h3 className="font-medium text-gray-500 text-sm uppercase tracking-wide">
									...
									<div className="min-w-0 flex-1">
										<div className="flex items-start justify-between">
											<div className="flex-1">
												...
												{activity.relatedEntity && (
													<motion.div
														...
														className="mt-2 inline-flex items-center gap-1 rounded bg-gray-100 px-2 py-1 text-gray-600 text-xs"
													>
											...
											{showTimestamp && (
												<span
													className={cn(
														"ml-2 flex-shrink-0 text-gray-500",
			...
			{maxItems && activities.length > maxItems && (
				...
				>
					<button className="font-medium text-primary text-sm hover:text-primary/80">
