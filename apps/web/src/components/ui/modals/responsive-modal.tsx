	...
	return createPortal(
		...
		>
			<motion.div
				ref={modalRef}
				className={cn(
					"relative overflow-hidden bg-background shadow-2xl",
					...
					isMobile &&
						(type === "gallery" || type === "wizard" || size === "full") &&
			...
			>
				...
				{dismissible && (
					<button
						...
						onClick={onClose}
						className={cn(
							"absolute z-10 rounded-full bg-background/80 p-2 text-muted-foreground transition-colors hover:bg-background hover:text-foreground",
