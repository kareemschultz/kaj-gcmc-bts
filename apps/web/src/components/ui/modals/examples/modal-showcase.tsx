...
const sampleWizardSteps = [
	{
		...
		content: (
			<div className="space-y-4">
				...
				<div>
					<label className="mb-1 block font-medium text-sm">Tax ID</label>
					<input
						type="text"
						className="w-full rounded-md border border-border px-3 py-2"
			...
			<div className="space-y-4">
				<div className="rounded-lg bg-muted p-4">
					...
					<p className="text-muted-foreground text-sm">
						Please review all information before submitting your tax service
						request.
					</p>
				</div>
				<div className="flex items-center space-x-2">
					...
					<label htmlFor="final-terms" className="text-sm">
						I confirm all information is accurate and agree to the terms of
						service
					</label>
				</div>
			</div>
...
export const ModalShowcase = memo(function ModalShowcase() {
	...
	const handleCustomConfirmation = async () => {
		const confirmed = await confirmDialog.confirm({
			...
			description:
				"Are you sure you want to submit this tax return? This action cannot be undone.",
			variant: "warning",
			confirmText: "Submit",
			cancelText: "Cancel",
		});
	...
	const handleCustomModal = () => {
		openModal({
			...
			content: (
				<div className="p-6">
					<h3 className="mb-4 font-semibold text-lg">Custom Modal Content</h3>
					<p className="mb-6 text-muted-foreground">
						This is a custom modal with completely custom content. You can put
						any React component here.
					</p>
					<div className="rounded-lg bg-muted p-4">
						<h4 className="mb-2 font-medium">Features Demonstrated:</h4>
		...
		openModal({
			...
			content: (
				<div className="flex h-full flex-col p-8">
					<h3 className="mb-4 font-bold text-2xl">Fullscreen Experience</h3>
					<div className="flex flex-1 items-center justify-center rounded-lg bg-muted p-6">
						<div className="text-center">
							<h4 className="mb-2 font-semibold text-xl">Full Screen Modal</h4>
							<p className="text-muted-foreground">
								This modal takes up the entire screen, perfect for complex
								workflows or detailed content.
							</p>
						</div>
					</div>
				</div>
	...
	return (
		<div className="p-6">
			<div className="mb-8">
				<h1 className="mb-2 font-bold text-3xl">Modal System Showcase</h1>
				<p className="text-muted-foreground">
					Comprehensive examples of the advanced modal system for GCMC-KAJ
					Business Tax Services Platform.
				</p>
			</div>
			...
			<div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
				{modalExamples.map((category, index) => (
					<Card key={index} className="p-6">
						<h2 className="mb-2 font-semibold text-xl">{category.title}</h2>
			...
			<div className="mt-8 rounded-lg bg-muted p-6">
				<h2 className="mb-3 font-semibold text-lg">Modal System Features</h2>
