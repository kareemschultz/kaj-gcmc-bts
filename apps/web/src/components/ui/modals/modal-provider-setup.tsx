...
export function ModalDeveloperTools() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9999] bg-background border border-border rounded-lg p-4 shadow-lg max-w-xs">
      <h3 className="font-semibold text-sm mb-2">Modal System Status</h3>
