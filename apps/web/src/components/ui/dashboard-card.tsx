			...
			<div className="flex items-center justify-between">
				<div className="flex-1">
					...
					{loading ? (
						...
						<>
							<p className="mb-1 font-bold text-3xl tracking-tight">{value}</p>
...
export function ClientCountCard({
	count,
	trend,
}: {
	count: number;
...
export function FilingCountCard({
	count,
	trend,
}: {
	count: number;
			...
			icon={() => (
				...
				>
					<path
						...
						strokeLinejoin="round"
						strokeWidth={2}
						d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 4v10m6-10v10m6-4V7a2 2 0 00-2-2h-4a2 2 0 00-2 2v4m-6 4h12"
					/>
				</svg>
			)}
			trend={trend}
