...
export const siteConfig = {
	...
	disclaimers: {
		general:
			"Professional services subject to applicable laws and regulations of Guyana.",
		liability:
			"GCMC-KAJ Business Tax Services provides professional consulting services. Clients remain responsible for the accuracy of information provided and compliance with all applicable laws.",
		confidentiality:
			"All client information is treated with strict confidentiality in accordance with professional standards and privacy regulations.",
	},
