...
export default function AnimationsDemoPage() {
	...
	const cycleStatus = () => {
		const statuses: Array<typeof status> = [
			"pending",
			"processing",
			"approved",
			"rejected",
			...
			<div className="container mx-auto space-y-8 py-8">
				<ScrollReveal animationType="slideUp">
					<div className="mb-8 text-center">
						...
						<p className="text-lg text-muted-foreground">
							Comprehensive micro-interactions and animations for business tax
							services
						</p>
						<div className="mt-4">
					...
					<Card>
						...
						<CardContent className="space-y-4">
							<div className="flex flex-wrap gap-4">
								<AnimatedButton animationType="default">
									Default Animation
								</AnimatedButton>
								...
								<AnimatedButton animationType="business">
									Business Style
								</AnimatedButton>
								<AnimatedButton
						...
						<CardContent className="space-y-6">
							<div className="grid grid-cols-1 gap-6 md:grid-cols-3">
								<div className="text-center">
									<h3 className="mb-4 font-semibold">Compliance Score</h3>
									<ComplianceScore
								...
								<div className="text-center">
									<h3 className="mb-4 font-semibold">Monetary Values</h3>
									<MonetaryValue
										value={monetaryValue}
								...
								<div className="text-center">
									<h3 className="mb-4 font-semibold">Status Changes</h3>
									<div className="mb-4">
										<StatusChangeAnimation
											status={status}
					...
					<Card>
						...
						<CardContent className="space-y-6">
							<div className="grid grid-cols-2 gap-4 text-center md:grid-cols-5">
								...
								<div>
									<h4 className="mb-2 font-medium">Business</h4>
				...
				<ScrollReveal animationType="slideUp">
					<Card>
						...
						<CardContent className="space-y-6">
							...
							<div>
								<h4 className="mb-2 font-medium">Swipeable Card</h4>
								<SwipeableCard
						...
						<CardContent>
							...
							>
								<div className="p-8 text-center">
									<h4 className="mb-2 font-medium">Content Area</h4>
									<p className="text-muted-foreground">
										This content will be overlaid with a loading animation when
				...
				<ScrollReveal animationType="slideUp">
					<div className="text-center text-muted-foreground">
						<p>
							Animation system built for GCMC-KAJ Business Tax Services Platform
						</p>
						<p className="mt-2 text-sm">
							All animations respect user preferences for reduced motion and
							accessibility
						</p>
					</div>
				</ScrollReveal>
