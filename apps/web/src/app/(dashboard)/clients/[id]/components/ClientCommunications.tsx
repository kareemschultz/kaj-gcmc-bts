...
interface ClientCommunicationsProps {
  ...
  onEditCommunication?: (id: string, communication: Partial<ClientCommunication>) => void;
...
export function ClientCommunications({
  ...
  const [selectedTypes, setSelectedTypes] = useState<Set<ClientCommunicationType>>(
  ...
  const [newCommunication, setNewCommunication] = useState<Partial<ClientCommunication>>({
    type: "email",
    direction: "outbound",
    isInternal: false,
  });
  ...
  const handleAddCommunication = () => {
    if (onAddCommunication && newCommunication.subject && newCommunication.content) {
      onAddCommunication({
        ...newCommunication,
        clientId,
              ...
              <div className="flex items-center space-x-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuSeparator />
                    {(Object.keys(COMMUNICATION_COLORS) as ClientCommunicationType[]).map((type) => (
                      <DropdownMenuCheckboxItem
                        key={type}
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div className="space-y-2">
                            ...
                            >
                              ...
                              <SelectContent>
                                {Object.keys(COMMUNICATION_COLORS).map((type) => (
                ...
                <CardContent className="pt-4">
                  {filteredCommunications.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <h3 className="mt-4 text-lg font-medium">No communications found</h3>
                              ...
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                                    <Badge
                                      variant={
                                        communication.direction === "inbound" ? "default" : "secondary"
                                      }
                                      className="text-xs"
                                    >
                                    ...
                                    <span>{formatDate(communication.communicatedAt)}</span>
                                  </div>
                                </div>
                              </div>
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  {onEditCommunication && (
                                    <DropdownMenuItem
                                      onClick={() =>
                                        onEditCommunication(communication.id, communication)
                                      }
                                    >
                                  ...
                                  {onDeleteCommunication && (
                                    <DropdownMenuItem
                                      onClick={() => onDeleteCommunication(communication.id)}
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                {onEditNote && (
                                  <DropdownMenuItem onClick={() => onEditNote(note.id, note)}>
                                    <Edit className="mr-2 h-4 w-4" />
                                    Edit
                                  </DropdownMenuItem>
                                )}
