...
import { getTemplateById, getTemplatesForAuthority } from "@/lib/form-builder/agency-templates";
...
export default function FormBuilderPage() {
  ...
  // Save form
  const handleSave = useCallback(async (configuration: FormConfiguration) => {
    setIsLoading(true);
    try {
  ...
  const handleImport = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      try {
        const configuration = JSON.parse(e.target?.result as string) as FormConfiguration;
        setCurrentForm(configuration);
      ...
      <Dialog open={showTemplateDialog} onOpenChange={setShowTemplateDialog}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            <div>
              <label className="text-sm font-medium">Filter by Authority</label>
              <Select value={selectedTemplate} onValueChange={setSelectedTemplate}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="GRA">GRA - Guyana Revenue Authority</SelectItem>
                  <SelectItem value="NIS">NIS - National Insurance Scheme</SelectItem>
                  <SelectItem value="DCRA">DCRA - Deeds & Commercial Registry</SelectItem>
