...
export type FormFieldType =
  ...
  | "textarea" | "select" | "multiselect" | "checkbox" | "radio" | "checkboxGroup"
  | "date" | "datetime" | "time" | "file" | "image"
  | "currency" | "percentage" | "tax_id" | "business_reg" | "nis_number"
  | "passport" | "id_card" | "signature" | "calculated" | "section" | "divider";

// Validation Rule Types
export type ValidationRuleType =
  | "required" | "minLength" | "maxLength" | "min" | "max" | "pattern" | "email" | "url"
  | "custom" | "conditional" | "crossField" | "businessRule" | "guyaneseSpecific";

// Calculation Types
export type CalculationType =
  | "sum" | "subtract" | "multiply" | "divide" | "percentage" | "compound"
  | "vat_calculation" | "nis_calculation" | "withholding_tax" | "penalty_calculation"
  | "fee_calculation" | "currency_conversion" | "custom_formula";
...
export interface ConditionalLogic {
  ...
  operator: "equals" | "not_equals" | "contains" | "not_contains" | "greater_than" | "less_than" | "in" | "not_in" | "empty" | "not_empty" | "regex";
  value: unknown;
  action: "show" | "hide" | "enable" | "disable" | "require" | "unrequire" | "calculate";
...
export type FormBuilderAction =
  ...
  | { type: "ADD_FIELD"; payload: { field: FormField; targetIndex?: number; section?: string } }
  | { type: "UPDATE_FIELD"; payload: { fieldId: string; updates: Partial<FormField> } }
  | { type: "REMOVE_FIELD"; payload: { fieldId: string } }
  | { type: "MOVE_FIELD"; payload: { fieldId: string; newIndex: number; newSection?: string } }
  | { type: "SELECT_FIELD"; payload: { fieldId?: string } }
  | { type: "ADD_SECTION"; payload: { section: FormSection; targetIndex?: number } }
