...
export type AnimationEasing = 'linear' | 'ease' | 'easeIn' | 'easeOut' | 'easeInOut' | 'spring' | 'bounce';
...
export interface BusinessAnimation {
  id: string;
  context: 'tax-filing' | 'compliance' | 'document-management' | 'client-portal' | 'dashboard';
...
// Utility types
export type AnimationTrigger = 'hover' | 'focus' | 'click' | 'scroll' | 'mount' | 'unmount' | 'update';
export type AnimationProperty = 'opacity' | 'scale' | 'x' | 'y' | 'rotate' | 'skew' | 'backgroundColor' | 'color';
