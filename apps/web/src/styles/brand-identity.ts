...
export const brandIdentity = {
  ...
  company: {
    ...
    description: "Professional business tax services and compliance management for Guyana enterprises",
  ...
  platform: {
    ...
    longDescription: "Comprehensive business tax compliance platform designed specifically for Guyana enterprises, featuring automated filing, document management, and regulatory compliance tracking.",
  },
  ...
  messaging: {
    ...
    missionStatement: "To empower Guyana businesses with streamlined tax compliance solutions that ensure regulatory adherence while maximizing operational efficiency.",

    visionStatement: "To become the leading digital platform for business compliance in the Caribbean region.",
...
export const marketingCopy = {
  ...
  testimonials: {
    ...
    themes: ["Time Savings", "Risk Reduction", "Professional Service", "Ease of Use"],
  },
};
