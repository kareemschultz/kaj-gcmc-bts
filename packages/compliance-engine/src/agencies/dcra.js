 ...
 */
export function calculateDCRADeadlines(business) {
	const deadlines = [];
	const now = new Date();
 ...
 */
export function assessDCRACompliance(business, filingHistory = []) {
 ...
 */
export function getDCRAForms(businessType) {
	const commonForms = [
 ...
 */
export function calculateDCRAComplianceCosts(businessType, _yearsInOperation) {
 ...
 */
export function getDCRAComplianceChecklist(businessType) {
	const commonItems = [
 ...
 */
export function validateBusinessName(proposedName, businessType) {
	const issues = [];
	const suggestions = [];
