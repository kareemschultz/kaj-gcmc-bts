 ...
 */
export function calculateNISContributions(weeklyEarnings, _isEmployer = false) {
 ...
 */
export function calculateSelfEmployedNIS(annualIncome) {
 ...
 */
export function calculateNISDeadlines(business) {
	const deadlines = [];
	const now = new Date();
 ...
 */
export function assessNISCompliance(business, _contributionHistory = []) {
 ...
 */
export function calculateAnnualNISBudget(business, avgMonthlyPayroll) {
