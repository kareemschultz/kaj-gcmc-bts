...
var XSS_FILTERS = {
    ...
    strict: {
        ...
        onIgnoreTagAttr: function (tag, name, value) {
            console.warn("🚨 Dangerous attribute blocked:", { tag: tag, name: name, value: value });
            return "";
        },
    },
    ...
    basic: {
        ...
        allowCommentTag: false,
        onTag: function (_tag, html, options) {
    ...
    document: {
        ...
        allowCommentTag: false,
        onTagAttr: function (_tag, name, value, isWhiteAttr) {
            ...
            if (name === "style") {
                return sanitizeStyle(value) ? "".concat(name, "=\"").concat(sanitizeStyle(value), "\"") : "";
            }
            // Allow whitelisted attributes
            if (isWhiteAttr) {
                return "".concat(name, "=\"").concat(validator_1.default.escape(value), "\"");
            }
            return "";
        },
    },
...
function detectXSSPayload(input) {
    ...
    for (var _i = 0, xssPatterns_1 = xssPatterns; _i < xssPatterns_1.length; _i++) {
        var _a = xssPatterns_1[_i], pattern = _a.pattern, risk = _a.risk;
...
function sanitizeRequestBody(obj, strictMode) {
    ...
    if (Array.isArray(obj)) {
        return obj.map(function (item) { return sanitizeRequestBody(item, strictMode); });
    }
    if (typeof obj === "object") {
        var sanitized = {};
        for (var _i = 0, _a = Object.entries(obj); _i < _a.length; _i++) {
