...
function detectSqlInjection(input) {
    ...
    for (var _i = 0, SQL_INJECTION_PATTERNS_1 = SQL_INJECTION_PATTERNS; _i < SQL_INJECTION_PATTERNS_1.length; _i++) {
...
function sanitizeSqlInput(input) {
    ...
    for (var _i = 0, dangerousKeywords_1 = dangerousKeywords; _i < dangerousKeywords_1.length; _i++) {
...
function validateOrderBy(orderBy, allowedColumns) {
    ...
    if (parts.length === 0 || parts.length > 2)
        return null;
    var column = parts[0];
    var direction = ((_a = parts[1]) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || "ASC";
    // Validate direction
...
exports.SqlSafeSchemas = {
    identifier: zod_1.z
        ...
        .refine(function (val) { return validateSqlIdentifier(val).isValid; }, "Invalid SQL identifier"),
    searchTerm: zod_1.z
        .string()
        .max(255)
 ...
 */
var SafeQueryBuilder = /** @class */ (function () {
    ...
    SafeQueryBuilder.prototype.addCondition = function (column, operator, value) {
        ...
        if (operator.toUpperCase() === "IN" ||
            ...
            var placeholders = value
                .map(function () { return "$".concat(_this.parameterIndex++); })
                .join(", ");
            this.conditions.push("".concat(escapedColumn, " ").concat(operator, " (").concat(placeholders, ")"));
            (_a = this.parameters).push.apply(_a, value);
        }
        else {
            this.conditions.push("".concat(escapedColumn, " ").concat(operator, " $").concat(this.parameterIndex++));
    ...
    SafeQueryBuilder.prototype.build = function () {
        var whereClause = this.conditions.length > 0
