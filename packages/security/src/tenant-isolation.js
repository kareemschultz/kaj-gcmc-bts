...
function validateTenantAccess(userId, tenantId) {
    return __awaiter(this, void 0, void 0, function () {
        var tenantUser, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, db_1.default.tenantUser.findFirst({
                            where: {
                                userId: userId,
                                tenantId: tenantId,
                            },
                ...
                case 1:
                    ...
                    if ((tenantUser === null || tenantUser === void 0 ? void 0 : tenantUser.role.name) === "Super Admin") {
    ...
    return {
        client: {
            findMany: function (args) {
                return db_1.default.client.findMany(withTenantIsolation(tenantId, args || {}));
            },
            findFirst: function (args) {
                return db_1.default.client.findFirst(withTenantIsolation(tenantId, args || {}));
            },
            findUnique: function (args) {
                // For unique queries, we need to verify tenant ownership after finding
                return db_1.default.client.findUnique(args).then(function (result) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
            ...
            update: function (args) {
                return db_1.default.client.update(withTenantIsolation(tenantId, args));
            },
            delete: function (args) {
                return db_1.default.client.delete(withTenantIsolation(tenantId, args));
            },
            count: function (args) {
                return db_1.default.client.count(withTenantIsolation(tenantId, args || {}));
            },
        },
        document: {
            findMany: function (args) {
                return db_1.default.document.findMany(__assign(__assign({}, args), { where: __assign(__assign({}, args === null || args === void 0 ? void 0 : args.where), { client: {
                            tenantId: tenantId,
                        } }) }));
            },
            findFirst: function (args) {
                return db_1.default.document.findFirst(__assign(__assign({}, args), { where: __assign(__assign({}, args === null || args === void 0 ? void 0 : args.where), { client: {
                            tenantId: tenantId,
                        } }) }));
            },
            findUnique: function (args) {
                return db_1.default.document
                    .findUnique(__assign(__assign({}, args), { include: __assign(__assign({}, args.include), { client: true }) }))
            ...
            update: function (args) {
                return db_1.default.document.update(__assign(__assign({}, args), { where: __assign(__assign({}, args.where), { client: {
                            tenantId: tenantId,
                        } }) }));
            },
            delete: function (args) {
                return db_1.default.document.delete(__assign(__assign({}, args), { where: __assign(__assign({}, args.where), { client: {
                            tenantId: tenantId,
                        } }) }));
            },
        },
        filing: {
            findMany: function (args) {
                return db_1.default.filing.findMany(__assign(__assign({}, args), { where: __assign(__assign({}, args === null || args === void 0 ? void 0 : args.where), { client: {
                            tenantId: tenantId,
                        } }) }));
            },
            findFirst: function (args) {
                return db_1.default.filing.findFirst(__assign(__assign({}, args), { where: __assign(__assign({}, args === null || args === void 0 ? void 0 : args.where), { client: {
                            tenantId: tenantId,
                        } }) }));
            },
            findUnique: function (args) {
                return db_1.default.filing
                    .findUnique(__assign(__assign({}, args), { include: __assign(__assign({}, args.include), { client: true }) }))
                    .then(function (result) {
                    if (result && result.client.tenantId !== tenantId) {
                        return null;
            ...
            create: function (args) {
                return db_1.default.filing.create(args);
            },
            update: function (args) {
                return db_1.default.filing.update(__assign(__assign({}, args), { where: __assign(__assign({}, args.where), { client: {
                            tenantId: tenantId,
                        } }) }));
            },
            delete: function (args) {
                return db_1.default.filing.delete(__assign(__assign({}, args), { where: __assign(__assign({}, args.where), { client: {
                            tenantId: tenantId,
                        } }) }));
            },
        },
...
function validateResourceTenantAccess(resourceType, resourceId, tenantId) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, client, document_1, filing, service, error_3;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case "filing": return [3 /*break*/, 5];
                        case "service": return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 9];
                case 1: return [4 /*yield*/, db_1.default.client.findFirst({
                        where: {
                ...
                case 3: return [4 /*yield*/, db_1.default.document.findFirst({
                        where: {
                            id: Number(resourceId),
                            client: {
                                tenantId: tenantId,
                ...
                case 5: return [4 /*yield*/, db_1.default.filing.findFirst({
                        where: {
                            id: Number(resourceId),
                            client: {
                                tenantId: tenantId,
                ...
                case 7: return [4 /*yield*/, db_1.default.serviceType.findFirst({
                        where: {
                            id: Number(resourceId),
                            tenantId: tenantId,
                        },
                ...
                case 11:
                    error_3 = _b.sent();
                    console.error("Error validating ".concat(resourceType, " tenant access:"), error_3);
                    return [2 /*return*/, false];
 ...
 */
function auditTenantAccess(userId, requestedTenantId, actualTenantId, resource, action, success) {
    return __awaiter(this, void 0, void 0, function () {
        var auditData;
        return __generator(this, function (_a) {
            auditData = {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, db_1.default.tenant.findUnique({
                            where: { id: tenantId },
                            select: {
                                settings: true,
...
function requireTenantAccess(allowedRoles) {
    ...
    return function (context, targetTenantId) { return __awaiter(_this, void 0, void 0, function () {
        var checkTenantId, hasAccess;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, validateTenantAccess(context.userId, checkTenantId)];
                case 1:
                    hasAccess = _a.sent();
                    if (!!hasAccess) return [3 /*break*/, 3];
                    return [4 /*yield*/, auditTenantAccess(context.userId, checkTenantId, context.tenantId, "api_access", "tenant_validation", false)];
                case 2:
                    _a.sent();
