...
const XSS_FILTERS = {
	...
	document: {
		whiteList: {
			...
			ol: ["class"] as string[],
			li: ["class"] as string[],
			blockquote: ["class"] as string[],
			a: ["href", "title", "target"] as string[],
			img: ["src", "alt", "title", "width", "height"] as string[],
			table: ["class"] as string[],
			thead: [] as string[],
			tbody: [] as string[],
			tr: [] as string[],
			th: ["colspan", "rowspan"] as string[],
			td: ["colspan", "rowspan"] as string[],
			div: ["class"] as string[],
