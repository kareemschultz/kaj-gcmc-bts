...
function hasPermission(context, permission) {
    return __awaiter(this, void 0, void 0, function () {
        var rolePermissions, modulePermissions, hasModuleAccess, _i, _a, inheritedRole, inheritedContext;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    hasModuleAccess = modulePermissions.includes(permission.action) ||
                ...
                case 1:
                    ...
                    inheritedRole = _a[_i];
                    inheritedContext = __assign(__assign({}, context), { role: inheritedRole });
...
function hasResourcePermission(context, permission) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, client, document_1, filing, targetUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 1:
                    ...
                    switch (_a) {
                        case "clients": return [3 /*break*/, 2];
                        case "documents": return [3 /*break*/, 4];
                        case "filings": return [3 /*break*/, 6];
                        case "users": return [3 /*break*/, 8];
                    }
                    return [3 /*break*/, 10];
                case 2: return [4 /*yield*/, db_1.default.client.findFirst({
                        where: {
                ...
                case 4: return [4 /*yield*/, db_1.default.document.findFirst({
                        where: {
                            id: Number(permission.resourceId),
                            client: {
                                tenantId: context.tenantId, // Tenant isolation
                ...
                case 6: return [4 /*yield*/, db_1.default.filing.findFirst({
                        where: {
                            id: Number(permission.resourceId),
                            client: {
                                tenantId: context.tenantId, // Tenant isolation
                ...
                case 9:
                    targetUser = _b.sent();
                    return [2 /*return*/, (targetUser !== null &&
...
function requirePermission(permission) {
    ...
    return function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, hasPermission(context, permission)];
                case 1:
                    allowed = _a.sent();
                    if (!allowed) {
                        throw new Error("Access denied: insufficient permissions for ".concat(permission.module, ".").concat(permission.action));
                    }
                    return [2 /*return*/, true];
            }
        });
...
function hasAnyPermission(context, permissions) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, permissions_2, permission;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function getRolePermissions(role) {
    ...
    if (!roleData)
        return [];
    var permissions = [];
    for (var _i = 0, _a = Object.entries(roleData.modules); _i < _a.length; _i++) {
        var _b = _a[_i], module_1 = _b[0], actions = _b[1];
...
function validateTenantAccess(userId, tenantId) {
    return __awaiter(this, void 0, void 0, function () {
        var userTenant, tenantUser, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    userTenant = _a.sent();
                    if ((userTenant === null || userTenant === void 0 ? void 0 : userTenant.role.name) === "Super Admin") {
                        return [2 /*return*/, true];
                    }
                    return [4 /*yield*/, db_1.default.tenantUser.findFirst({
                            where: {
