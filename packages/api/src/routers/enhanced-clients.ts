...
// Performance metrics
const routerMetrics = {
  requestCounter: metrics.createCounter('client_router_requests_total', 'Total client router requests'),
  requestDuration: metrics.createTimer('client_router_request_duration', 'Client router request duration'),
  cacheHitCounter: metrics.createCounter('client_router_cache_hits_total', 'Client router cache hits')
};
...
export const enhancedClientsRouter = router({
  ...
  list: rbacProcedure("clients", "view")
    ...
    .query(async ({ ctx, input }) => {
      return routerMetrics.requestDuration.timeAsync(async () => {
        routerMetrics.requestCounter.increment({ operation: 'list', tenantId: ctx.tenantId.toString() });

        try {
          const container = getContainer();
          const clientService = container.resolve<ClientService>(ServiceTokens.CLIENT_SERVICE);
  ...
  get: rbacProcedure("clients", "view")
    ...
    .query(async ({ ctx, input }) => {
      return routerMetrics.requestDuration.timeAsync(async () => {
        routerMetrics.requestCounter.increment({ operation: 'get', tenantId: ctx.tenantId.toString() });
        ...
        try {
          ...
          // Fetch from service
          const client = await clientService.getClient(input.id, ctx.tenantId);
  ...
  create: rbacProcedure("clients", "create")
    ...
    .mutation(async ({ ctx, input }) => {
      return routerMetrics.requestDuration.timeAsync(async () => {
        routerMetrics.requestCounter.increment({ operation: 'create', tenantId: ctx.tenantId.toString() });
        ...
        try {
          ...
          const client = await clientService.createClient(input, ctx.tenantId, user);
  ...
  update: rbacProcedure("clients", "edit")
    ...
    .mutation(async ({ ctx, input }) => {
      return routerMetrics.requestDuration.timeAsync(async () => {
        routerMetrics.requestCounter.increment({ operation: 'update', tenantId: ctx.tenantId.toString() });
  ...
  delete: rbacProcedure("clients", "delete")
    ...
    .mutation(async ({ ctx, input }) => {
      return routerMetrics.requestDuration.timeAsync(async () => {
        routerMetrics.requestCounter.increment({ operation: 'delete', tenantId: ctx.tenantId.toString() });
  ...
  assessRisk: rbacProcedure("clients", "edit")
    ...
    .mutation(async ({ ctx, input }) => {
      return routerMetrics.requestDuration.timeAsync(async () => {
        routerMetrics.requestCounter.increment({ operation: 'assess_risk', tenantId: ctx.tenantId.toString() });
   ...
   */
  stats: rbacProcedure("clients", "view")
    .query(async ({ ctx }) => {
      return routerMetrics.requestDuration.timeAsync(async () => {
        routerMetrics.requestCounter.increment({ operation: 'stats', tenantId: ctx.tenantId.toString() });
