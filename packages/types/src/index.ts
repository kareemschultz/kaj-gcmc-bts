...
export type ClientProfileStatus = "active" | "inactive" | "suspended" | "archived";
...
export interface DocumentValidationRule {
  id: string;
  name: string;
  ruleType: "required_field" | "format" | "size" | "date_range" | "calculation" | "cross_reference";
  field?: string;
  condition: {
    operator: "equals" | "contains" | "regex" | "range" | "required" | "optional";
    value?: unknown;
    min?: number;
    max?: number;
    pattern?: string;
...
export interface ComplianceAlert {
  ...
  authority: Authority;
  clientId: number;
  type: "deadline_approaching" | "document_expired" | "penalty_accruing" | "requirement_changed" | "system_update";
...
export interface WorkflowStep {
  ...
  name: string;
  description: string;
  type: "validation" | "approval" | "notification" | "submission" | "wait" | "condition";
  config: {
    assignedRole?: string;
    timeoutHours?: number;
...
export interface WorkflowTrigger {
  id: string;
  type: "document_upload" | "date_based" | "status_change" | "manual" | "api_call";
...
export interface WorkflowCondition {
  field: string;
  operator: "equals" | "not_equals" | "greater_than" | "less_than" | "contains" | "exists" | "is_null";
  value: unknown;
...
export interface WorkflowAction {
  type: "send_notification" | "create_task" | "update_status" | "generate_document" | "submit_to_agency" | "calculate_fee";
...
export interface SubmissionEvent {
  id: string;
  type: "submitted" | "acknowledged" | "under_review" | "approved" | "rejected" | "additional_info_requested" | "payment_required" | "completed";
  timestamp: Date;
