...
test.describe("Client Management Tests", () => {
	...
	test("Clients page loads with client list", async ({ page }) => {
		...
		await page.screenshot({
			path: "test-results/testzeus-hercules/screenshots/clients-page.png",
		});
	});
	...
	test("Add new client form works", async ({ page }) => {
		...
		await page.screenshot({
			path: "test-results/testzeus-hercules/screenshots/add-client-form.png",
		});
		...
		await page.screenshot({
			path: "test-results/testzeus-hercules/screenshots/client-added.png",
		});
	});
	...
	test("Client details view works", async ({ page }) => {
		...
		await page.screenshot({
			path: "test-results/testzeus-hercules/screenshots/client-details.png",
		});
	});
});
