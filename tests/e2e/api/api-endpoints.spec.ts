...
test.describe("API Endpoints - Authentication", () => {
	...
	test("should authenticate with valid credentials @api-critical", async ({
		apiHelper,
	}) => {
	...
	test("should authenticate with test user credentials @api-functional", async ({
		apiHelper,
	}) => {
	...
	test("should reject invalid credentials @api-negative", async ({
		apiHelper,
	}) => {
		await allure.step(
	...
	test("should get current user profile @api-functional", async ({
		apiHelper,
	}) => {
...
test.describe("API Endpoints - Clients CRUD", () => {
	...
	test("should validate required fields when creating client @api-validation", async ({
		apiHelper,
	}) => {
		await allure.step(
	...
	test("should validate email format @api-validation", async ({
		apiHelper,
	}) => {
	...
	test("should get clients with pagination @api-functional", async ({
		apiHelper,
	}) => {
...
test.describe("API Endpoints - Filings", () => {
	...
	test("should filter filings by client @api-functional", async ({
		apiHelper,
	}) => {
		await allure.step("Create test client", async () => {
			const client = await apiHelper.createTestClient();
...
test.describe("API Endpoints - Reports", () => {
	...
	test("should generate client report @api-functional", async ({
		apiHelper,
	}) => {
...
test.describe("API Endpoints - Health and Status", () => {
	...
	test("should provide status information @api-health", async ({
		apiHelper,
	}) => {
...
test.describe("API Endpoints - Error Handling", () => {
	...
	test("should handle unauthorized requests @api-security", async ({
		apiHelper,
	}) => {
	...
	test("should handle non-existent resource @api-negative", async ({
		apiHelper,
	}) => {
	...
	test("should validate request payload @api-validation", async ({
		apiHelper,
	}) => {
